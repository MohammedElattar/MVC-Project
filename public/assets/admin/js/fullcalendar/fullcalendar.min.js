...
(function (m, ma) {
  ...
  function Zb(a, b) {
    function e() {
      q = b.theme ? "ui" : "fc";
      if (b.header)
        return (Q = m("<table class='fc-header' style='width:100%'/>").append(
          m("<tr/>").append(f("left")).append(f("center")).append(f("right"))
        ));
    }
    function d() {
      Q.remove();
                ...
                if (na) {
                  na.click(function () {
                    ...
                    .hover(
                      ...
                      function () {
                        na.removeClass(q + "-state-hover").removeClass(
                          q + "-state-down"
                        );
                      }
                    )
  ...
  function gc(a) {
    return (
      (parseFloat(m.css(a[0], "paddingLeft", true)) || 0) +
      (parseFloat(m.css(a[0], "paddingRight", true)) || 0)
    );
  }
  function ic(a) {
    return (
      (parseFloat(m.css(a[0], "marginLeft", true)) || 0) +
      (parseFloat(m.css(a[0], "marginRight", true)) || 0)
    );
  }
  function hc(a) {
    return (
      (parseFloat(m.css(a[0], "borderLeftWidth", true)) || 0) +
  ...
  function jc(a) {
    return (
      (parseFloat(m.css(a[0], "paddingTop", true)) || 0) +
      (parseFloat(m.css(a[0], "paddingBottom", true)) || 0)
    );
  }
  function Fb(a) {
    return (
      (parseFloat(m.css(a[0], "marginTop", true)) || 0) +
      (parseFloat(m.css(a[0], "marginBottom", true)) || 0)
    );
  }
  function kc(a) {
    return (
      (parseFloat(m.css(a[0], "borderTopWidth", true)) || 0) +
  ...
  m.fn.fullCalendar = function (a) {
    ...
    a = m.extend(
      ...
      {},
      Ya,
      a.isRTL || (a.isRTL === ma && Ya.isRTL) ? yc : {},
      a
    );
