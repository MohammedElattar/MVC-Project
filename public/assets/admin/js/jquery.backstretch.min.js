  ...
  (e.fn.backstretch = function (r, s) {
    return (
      ...
      this.each(function () {
        ...
        n && ((s = e.extend(n.options, s)), n.destroy(!0)),
          (n = new i(this, r, s)),
  ...
  var r = {
    ...
    i = function (n, i, o) {
      (this.options = e.extend({}, e.fn.backstretch.defaults, o || {})),
        ...
        (this.$container = e(n)),
        (this.$wrap = e('<div class="backstretch"></div>')
          .css(r.wrap)
    ...
    resize: function () {
      try {
        ...
        s >= i
          ...
          this.$wrap
            .css({ width: n, height: i })
            .find("img:not(.deleteable)")
            .css({ width: r, height: s })
            .css(e);
      } catch (u) { }
      return this;
    },
  ...
  var s = (function () {
    ...
    return !(
      ((n.indexOf("iPhone") > -1 ||
        ...
        i &&
        i < 534) ||
      (t.operamini && {}.toString.call(t.operamini) === "[object OperaMini]") ||
      (u && a < 7458) ||
      (e.indexOf("Android") > -1 && i && i < 533) ||
      (o && o < 6) ||
      ("palmGetResource" in t && i && i < 534) ||
      (e.indexOf("MeeGo") > -1 && e.indexOf("NokiaBrowser/8.5.0") > -1) ||
      (l && l <= 6)
    );
  })();
})(jQuery, window);
